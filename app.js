...
function getAutoThirdPlaceTeams() {
  return GROUP_NAMES.filter((group) => isGroupComplete(group))
...
function restoreLocalPrediction() {
  try {
    ...
    if (data.knockout?.matches) {
      Object.values(data.knockout.matches)
        .flat()
        .forEach((match) => {
      ...
      ["round32", "round16", "quarterfinals", "semifinals"].forEach((round) => {
        ...
        (data.knockout[round] || []).forEach((team, index) => {
          if (treeArr[index] && team)
            state.knockoutResults[treeArr[index].num] = team;
        });
      });
      if (data.knockout.final && KO_TREE.final?.[0])
        state.knockoutResults[KO_TREE.final[0].num] = data.knockout.final;
      if (data.knockout.thirdPlace && KO_TREE.thirdPlace?.[0])
        state.knockoutResults[KO_TREE.thirdPlace[0].num] =
  ...
  try {
    ...
    data.matches
      ...
      .forEach((m, index) => {
        ...
        if (!GROUP_MATCHES_BY_GROUP[letter])
          GROUP_MATCHES_BY_GROUP[letter] = [];
    ...
    KO_TREE = {
      round32: [
        {
          num: 73,
          slot1: { type: "runner_up", group: "A" },
          slot2: { type: "runner_up", group: "B" },
        },
        {
          num: 74,
          slot1: { type: "winner", group: "E" },
          slot2: { type: "third_place", groups: ["A", "B", "C", "D", "F"] },
        },
        {
          num: 75,
          slot1: { type: "winner", group: "F" },
          slot2: { type: "runner_up", group: "C" },
        },
        {
          num: 76,
          slot1: { type: "winner", group: "C" },
          slot2: { type: "runner_up", group: "F" },
        },
        {
          num: 77,
          slot1: { type: "winner", group: "I" },
          slot2: { type: "third_place", groups: ["C", "D", "F", "G", "H"] },
        },
        {
          num: 78,
          slot1: { type: "runner_up", group: "E" },
          slot2: { type: "runner_up", group: "I" },
        },
        {
          num: 79,
          slot1: { type: "winner", group: "A" },
          slot2: { type: "third_place", groups: ["C", "E", "F", "H", "I"] },
        },
        {
          num: 80,
          slot1: { type: "winner", group: "L" },
          slot2: { type: "third_place", groups: ["E", "H", "I", "J", "K"] },
        },
        {
          num: 81,
          slot1: { type: "winner", group: "D" },
          slot2: { type: "third_place", groups: ["B", "E", "F", "I", "J"] },
        },
        {
          num: 82,
          slot1: { type: "winner", group: "G" },
          slot2: { type: "third_place", groups: ["A", "E", "H", "I", "J"] },
        },
        {
          num: 83,
          slot1: { type: "runner_up", group: "K" },
          slot2: { type: "runner_up", group: "L" },
        },
        {
          num: 84,
          slot1: { type: "winner", group: "H" },
          slot2: { type: "runner_up", group: "J" },
        },
        {
          num: 85,
          slot1: { type: "winner", group: "B" },
          slot2: { type: "third_place", groups: ["E", "F", "G", "I", "J"] },
        },
        {
          num: 86,
          slot1: { type: "winner", group: "J" },
          slot2: { type: "runner_up", group: "H" },
        },
        {
          num: 87,
          slot1: { type: "winner", group: "K" },
          slot2: { type: "third_place", groups: ["D", "E", "I", "J", "L"] },
        },
        {
          num: 88,
          slot1: { type: "runner_up", group: "D" },
          slot2: { type: "runner_up", group: "G" },
        },
      ],
      round16: [
        {
          num: 89,
          slot1: { type: "winner_of", matchNum: 73 },
          slot2: { type: "winner_of", matchNum: 75 },
        },
        {
          num: 90,
          slot1: { type: "winner_of", matchNum: 74 },
          slot2: { type: "winner_of", matchNum: 77 },
        },
        {
          num: 91,
          slot1: { type: "winner_of", matchNum: 76 },
          slot2: { type: "winner_of", matchNum: 78 },
        },
        {
          num: 92,
          slot1: { type: "winner_of", matchNum: 79 },
          slot2: { type: "winner_of", matchNum: 80 },
        },
        {
          num: 93,
          slot1: { type: "winner_of", matchNum: 83 },
          slot2: { type: "winner_of", matchNum: 84 },
        },
        {
          num: 94,
          slot1: { type: "winner_of", matchNum: 81 },
          slot2: { type: "winner_of", matchNum: 82 },
        },
        {
          num: 95,
          slot1: { type: "winner_of", matchNum: 86 },
          slot2: { type: "winner_of", matchNum: 88 },
        },
        {
          num: 96,
          slot1: { type: "winner_of", matchNum: 85 },
          slot2: { type: "winner_of", matchNum: 87 },
        },
      ],
      quarterfinals: [
        {
          num: 97,
          slot1: { type: "winner_of", matchNum: 89 },
          slot2: { type: "winner_of", matchNum: 90 },
        },
        {
          num: 98,
          slot1: { type: "winner_of", matchNum: 93 },
          slot2: { type: "winner_of", matchNum: 94 },
        },
        {
          num: 99,
          slot1: { type: "winner_of", matchNum: 91 },
          slot2: { type: "winner_of", matchNum: 92 },
        },
        {
          num: 100,
          slot1: { type: "winner_of", matchNum: 95 },
          slot2: { type: "winner_of", matchNum: 96 },
        },
      ],
      semifinals: [
        {
          num: 101,
          slot1: { type: "winner_of", matchNum: 97 },
          slot2: { type: "winner_of", matchNum: 98 },
        },
        {
          num: 102,
          slot1: { type: "winner_of", matchNum: 99 },
          slot2: { type: "winner_of", matchNum: 100 },
        },
      ],
      thirdPlace: [
        {
          num: 103,
          slot1: { type: "loser_of", matchNum: 101 },
          slot2: { type: "loser_of", matchNum: 102 },
        },
      ],
      final: [
        {
          num: 104,
          slot1: { type: "winner_of", matchNum: 101 },
          slot2: { type: "winner_of", matchNum: 102 },
        },
      ],
    };
...
function findTeamGroup(teamName) {
  ...
  return TEAMS_BY_GROUP
    ? Object.keys(TEAMS_BY_GROUP).find((g) =>
        TEAMS_BY_GROUP[g].some((t) => t.name === teamName),
      )
    : null;
}

function getTeamFlagClass(teamName) {
  return getFlagClass(teamName);
}
  ...
  for (let i = 0; i < teams.length; i++) {
    for (let j = i + 1; j < teams.length; j++) {
      matches.push({
        team1: teams[i],
        team2: teams[j],
        key: groupMatchKey(teams[i], teams[j]),
        date: "",
        time: "",
        round: "",
        ground: "",
...
function calculateGroupStandings(group) {
  ...
  const byPoints = [...Object.values(stats)].sort(
    (a, b) => b.pts - a.pts || overallCompare(a, b),
  );
...
function isGroupComplete(group) {
  ...
  return getGroupMatchList(group).every((match) => {
    const result = state.groupMatches[group]?.[match.key] || {};
    return (
      parseGoalValue(result.home) !== null &&
      parseGoalValue(result.away) !== null
    );
  });
}
...
function openGroupResultsModal(group) {
  ...
  function redrawStandings() {
    ...
    viewer.querySelectorAll(".score-input").forEach((input) => {
      if (!tmp[input.dataset.key])
        tmp[input.dataset.key] = { home: null, away: null };
    ...
    freshStandings.forEach((row, idx) => {
      ...
      item.className =
        "group-team pos-" + (idx + 1) + (idx >= 3 ? " eliminated" : "");
      item.innerHTML = `
  ...
  viewer
    ...
    .forEach((input) => input.addEventListener("input", redrawStandings));
  redrawStandings();

  document
    .getElementById("cancelGroupResults")
  ...
  document.getElementById("saveGroupResults").addEventListener("click", () => {
    ...
    viewer.querySelectorAll(".score-input").forEach((input) => {
      if (!state.groupMatches[group][input.dataset.key]) {
        state.groupMatches[group][input.dataset.key] = {
          home: null,
          away: null,
        };
      }
      state.groupMatches[group][input.dataset.key][input.dataset.side] =
        parseGoalValue(input.value);
    });
...
function getSlotTeam(ref) {
  if (!ref) return null;
  if (ref.type === "winner")
    return isGroupComplete(ref.group) && state.groups[ref.group]
      ? state.groups[ref.group][0]
      : null;
  if (ref.type === "runner_up")
    return isGroupComplete(ref.group) && state.groups[ref.group]
      ? state.groups[ref.group][1]
      : null;
  if (ref.type === "third_place") return tpAllocation[ref._matchNum] || null;
  if (ref.type === "winner_of")
    return state.knockoutResults[ref.matchNum] || null;
...
function renderGroups() {
  ...
  GROUP_NAMES.forEach((g) => {
    ...
    card.type = "button";
    card.className =
      "group-card group-card-clickable" +
      (complete ? " group-complete" : " group-empty");
    card.title = complete
      ? "Editar resultados del grupo " + g
      : "Meter resultados del grupo " + g;
...
function renderThirdPlace() {
  ...
  if (picked.length === 0) {
    container.innerHTML =
      '<p class="note-text">Se calcularán solos cuando metas todos los resultados de grupos.</p>';
    return;
  }
...
function renderBracket() {
  ...
  ["Dieciseisavos", "Octavos", "Cuartos", "Semis", "Final"].forEach(
    (lbl, i) => {
  ...
  function connect(srcTree, srcTops, dstTree, dstTops, srcLeft, dstLeft) {
    ...
    dstTree.forEach((dst, di) => {
      ...
      svg.appendChild(
        mkPath(`M${sx},${y1} L${mx},${y1} L${mx},${yd} L${dx},${yd}`),
      );
      svg.appendChild(
        mkPath(`M${sx},${y2} L${mx},${y2} L${mx},${yd} L${dx},${yd}`),
      );
    });
  }
  ...
  wrapper.appendChild(
    slotDiv(
      finalMatch.team1,
      Boolean(
        finalMatch.team1 && finalWinner && finalMatch.team1 === finalWinner,
      ),
      finNum,
      1,
      finalTop,
  ...
  wrapper.appendChild(
    slotDiv(
      finalMatch.team2,
      Boolean(
        finalMatch.team2 && finalWinner && finalMatch.team2 === finalWinner,
      ),
      finNum,
      2,
      finalTop + SLOT_H,
...
function sameMatchTeams(a, b) {
  return (
    (a?.team1 || null) === (b?.team1 || null) &&
    (a?.team2 || null) === (b?.team2 || null)
  );
}
...
function cleanupKnockoutAfterGroupChange(previousMatchTeams) {
  ...
  while (changed && guard < 20) {
    ...
    Object.keys(state.knockoutResults).forEach((matchNum) => {
      ...
      const winnerStillInMatch =
        pickedWinner &&
        (pickedWinner === currentTeams.team1 ||
          pickedWinner === currentTeams.team2);

      const matchupChanged =
        previousMatchTeams && !sameMatchTeams(previousTeams, currentTeams);
...
function openAwardPickerModal(select) {
  ...
  const label =
    select.closest(".award-row")?.querySelector("label")?.textContent?.trim() ||
    "Elegir jugador";
  ...
  empty.dataset.value = "";
  empty.innerHTML =
    '<span class="award-placeholder">---</span><span class="award-player-country">Sin elegir</span>';
  ...
  AWARD_PLAYERS.forEach((player) => {
    ...
    option.type = "button";
    option.className =
      "award-picker-option" + (currentValue === player.name ? " selected" : "");
...
function buildPayload() {
  ...
  function winners(nums) {
    return nums.map((n) => state.knockoutResults[n]).filter(Boolean);
  }
  ...
  const finalNum =
    KO_TREE.final && KO_TREE.final[0] ? KO_TREE.final[0].num : null;
  const thirdNum =
    KO_TREE.thirdPlace && KO_TREE.thirdPlace[0]
      ? KO_TREE.thirdPlace[0].num
      : null;
  ...
  const runnerUp = champion
    ? [finalMatch.team1, finalMatch.team2].find(
        (team) => team && team !== champion,
      ) || null
    : null;
  const thirdPlaceWinner = thirdNum
    ? state.knockoutResults[thirdNum] || null
    : null;
...
function getChampionFromPayload(payload) {
  return (
    payload?.champion ||
    payload?.knockout?.champion ||
    payload?.knockout?.final ||
    null
  );
}

function getRunnerUpFromPayload(payload) {
  if (payload?.runnerUp || payload?.knockout?.runnerUp)
    return payload.runnerUp || payload.knockout.runnerUp;
...
function getKnockoutStageTeamSets(payload) {
  ...
  const thirdWinner = thirdNum
    ? reviewState.knockoutResults?.[thirdNum]
    : getThirdPlaceWinnerFromPayload(payload);
  const champion = finalNum
    ? reviewState.knockoutResults?.[finalNum]
  ...
  return {
    ...
    quarterfinals: new Set(
      getTeamsFromReviewMatches(reviewState, KO_TREE.quarterfinals),
    ),
    semifinals: new Set(
      getTeamsFromReviewMatches(reviewState, KO_TREE.semifinals),
    ),
    finalist: new Set(
      uniqueTeamList([
        finalMatch.team1,
...
function getKnockoutProgressPointsForTeam(
  team,
  roundName,
  realStageTeams,
  predictedState,
  ...
  let points = realStageTeams[stage]?.has(team)
    ? KNOCKOUT_SCORING[stage] || 0
    : 0;

  if (roundName === "final") {
    const finalNum = KO_TREE.final?.[0]?.num;
    const predictedChampion = finalNum
      ? predictedState?.knockoutResults?.[finalNum]
      : null;
...
function getKnockoutScoreBreakdown(prediction, results = RESULTS) {
  ...
  ["round32", "round16", "quarterfinals", "semifinals", "finalist"].forEach(
    (stage) => {
...
function getThirdPlaceWinnerFromPayload(payload) {
  return (
    ...
    payload?.knockout?.thirdPlaceWinner ||
    payload?.knockout?.thirdPlace ||
    null
  );
}
...
function getSemifinalistsFromPayload(payload) {
  return (
    ...
    payload?.knockout?.semifinalists ||
    payload?.knockout?.semifinals ||
    []
  );
}
...
function scorePrediction(prediction, results = RESULTS) {
  ...
  GROUP_NAMES.forEach((group) => {
    ...
    if (predictionResultStatus(predGroup[0], realGroup[0]) === "correct")
      score += puntuaciones.grupos.posicion.primero;
    if (predictionResultStatus(predGroup[1], realGroup[1]) === "correct")
      score += puntuaciones.grupos.posicion.segundo;
    if (predictionResultStatus(predGroup[2], realGroup[2]) === "correct")
      score += puntuaciones.grupos.posicion.tercero;
    ...
    getGroupMatchList(group).forEach((match) => {
      ...
      if (ph === rh && pa === ra)
        score += puntuaciones.grupos.partido.resultadoExacto;
      else if (getResultOutcome(ph, pa) === getResultOutcome(rh, ra))
        score += puntuaciones.grupos.partido.ganadorEmpateCorrecto;
    });
  });
...
function withPredictionGroupMatches(prediction, fn) {
  ...
  state.groupMatches = normalizeGroupMatchesForStandings(
    prediction.groupMatches || {},
  );
...
function getQualifiedTeamsFromOrder(order, thirdsSet) {
  return new Set(
    (order || []).filter(
      (team, idx) => idx < 2 || (idx === 2 && thirdsSet.has(team)),
    ),
  );
}

function getPredictionStandingReviewClass(
  team,
  predIdx,
  predOrder,
  predThirds,
  ...
  const predQualified = getQualifiedTeamsFromOrder(predOrder, predThirds).has(
    team,
  );
  const realQualified = getQualifiedTeamsFromOrder(realOrder, realThirds).has(
    team,
  );
...
function getGroupMatchReviewPoints(ph, pa, rh, ra) {
  ...
  if (ph === rh && pa === ra)
    return puntuaciones.grupos.partido.resultadoExacto;
  return getResultOutcome(ph, pa) === getResultOutcome(rh, ra)
    ? puntuaciones.grupos.partido.ganadorEmpateCorrecto
    : 0;
}

function getPredictedGroupPositionPoints(
  team,
  idx,
  autoThirds,
  realOrder,
...
function calculateGroupReviewTotalPoints(group, prediction) {
  ...
  const positionPoints = standings.reduce((total, row, idx) => {
    return (
      total +
      getPredictedGroupPositionPoints(
        row.team,
        idx,
        autoThirds,
        realOrder,
...
function renderReviewGroups(prediction, entry) {
  ...
  GROUP_NAMES.forEach((g) => {
    ...
    card.type = "button";
    card.className =
      "group-card group-card-clickable review-group-card" +
      (complete ? " group-complete" : " group-empty");
    ...
    const groupTotalPoints = complete
      ? calculateGroupReviewTotalPoints(g, prediction)
      : 0;
    const totalBadge = document.createElement("span");
    totalBadge.className =
      "review-group-total-points" +
      (groupTotalPoints > 0 ? " got-points" : " no-points");
    totalBadge.title = "Total de puntos conseguidos en el grupo " + g;
    totalBadge.textContent = `+${groupTotalPoints}pt`;
    +(groupTotalPoints === 1 ? "" : "s");
    ...
    if (!complete) {
      ...
      standings.forEach((stat, idx) => {
        ...
        const statusClass = realOrder.length
          ? getPredictionStandingReviewClass(
              team,
              idx,
              predOrder,
              autoThirds,
    ...
    card.addEventListener("click", () =>
      openReadOnlyGroupResultsModal(entry, g),
    );
...
function openReadOnlyGroupResultsModal(entry, group) {
  ...
  matches.forEach((match) => {
    ...
    const outcome =
      ...
      ph !== null &&
      pa !== null &&
      getResultOutcome(ph, pa) === getResultOutcome(rh, ra);
  ...
  const predictedStandingsDiv = viewer.querySelector(
    "#predictedGroupStandings",
  );
  const positionPointsDiv = viewer.querySelector(
    "#predictedGroupPositionPoints",
  );
  ...
  predictedStandingsDiv.innerHTML = standings
    .map((row, idx) => {
      const isThird = idx === 2;
      const isFourth = idx === 3;
      ...
      return renderStandingRow({
        ...
        extraClass:
          (eliminated ? " eliminated" : "") +
          (isThird && autoThirds.has(row.team) ? " qualified-third" : ""),
      });
    })
    .join("");

  positionPointsDiv.innerHTML = standings
    .map((row, idx) => {
      const points = getPredictedGroupPositionPoints(
        row.team,
        idx,
        autoThirds,
        realOrder,
  ...
  realStandingsDiv.innerHTML = realOrder
    .map((team, idx) => {
      const realRow = calculateRealGroupStandingsFromResults(group).find(
        (stat) => stat.team === team,
      ...
      return renderStandingRow({
        ...
        extraClass:
          classified && idx === 2 ? " qualified-third" : " eliminated",
      });
    })
    .join("");

  document
    .getElementById("backToPredictionReview")
    .addEventListener("click", () => renderPredictionReview(entry));
}
...
function buildKnockoutReviewState(source) {
  ...
  if (KO_TREE.final?.[0] && !state.knockoutResults[KO_TREE.final[0].num]) {
    setWinnerIfPossible(
      KO_TREE.final[0],
      knockout.final || knockout.champion || source.champion,
    );
  }

  if (
    KO_TREE.thirdPlace?.[0] &&
    !state.knockoutResults[KO_TREE.thirdPlace[0].num]
  ) {
    setWinnerIfPossible(
      KO_TREE.thirdPlace[0],
      knockout.thirdPlace ||
        knockout.thirdPlaceWinner ||
        source.thirdPlaceWinner,
    );
  }
...
function renderKnockoutBracket(reviewState, titleText, options = {}) {
  ...
  const wrapper = document.createElement("div");
  wrapper.className =
    "bracket review-knockout-bracket" +
  ...
  title.style.cssText =
    "position:absolute;top:0;left:10px;width:" +
    (COL_W * 5 + CONN_W * 4) +
    "px;";
  ...
  function slotDiv(team, winner, top, left, matchNum, roundName) {
    ...
    const isClickable = Boolean(
      options.onMatchClick && matchInfo?.realHasMatch,
    );
    const slotPoints =
      hasTeam && typeof options.getSlotPoints === "function"
    ...
    d.innerHTML =
      (slotPoints !== null
        ? '<span class="review-knockout-slot-points ' +
          (slotPoints > 0 ? "got-points" : "") +
          '">' +
          escapeHtml(`+${slotPoints}pt`) +
          "</span>"
        : "") +
      '<span class="slot-flag ' +
      getFlagClass(team) +
  ...
  function drawRound(matches, tops, colIdx) {
    ...
    matches.forEach((m, i) => {
      const roundName =
        ["round32", "round16", "quarterfinals", "semifinals"][colIdx] || "";
      wrapper.appendChild(
        slotDiv(m.team1, m.winner, tops[i], left, m.num, roundName),
      );
      wrapper.appendChild(
        slotDiv(m.team2, m.winner, tops[i] + SLOT_H, left, m.num, roundName),
      );
    });
  }
...
function renderReviewKnockout(prediction) {
  ...
  function closeKnockoutPopover() {
    document
      .querySelectorAll(".knockout-match-popover")
  ...
  function getBracketSlotPoints(team, roundName) {
    return getKnockoutProgressPointsForTeam(
      team,
      roundName,
      realStageTeams,
      predictedState,
  ...
  pane.className =
    "bracket-wrapper review-knockout-pane review-knockout-click-pane";
...
function renderReviewAwards(prediction) {
  ...
  const rows = [
    [
      `Bota de oro (${puntuaciones.premios.goldenBoot[0]}pt)`,
      prediction.awards?.goldenBoot?.[0],
...
function renderLeaderboard(entries) {
  ...
  if (!entries || entries.length === 0) {
    div.innerHTML =
      '<p class="note-text" style="margin-top:20px;">No predictions found.</p>';
    return;
  }
...
async function confirmSubmitPrediction() {
  ...
  try {
    ...
    fireConfetti();
    showToast(
      "Listo, buena suerte. Puede tardar unos segundos en aparecer en el ranking.",
    );
  } catch (e) {
    hideLoading();
...
async function init() {
  ...
  if (!ok) {
    showToast(
      "Failed to load tournament data. Check connection and reload.",
      true,
    );
    return;
  }
  ...
  document
    .getElementById("confirmNameSubmit")
    .addEventListener("click", confirmSubmitPrediction);
  document
    .getElementById("cancelNameSubmit")
  ...
  document
    .getElementById("closePredictionModal")
    .addEventListener("click", closePredictionModal);
