...
declare const EXT_TO_FORMAT: Map<string, string>;
...
export { EXT_TO_FORMAT, FORMATS, type IFormatMeta, type ISourceOptions, Tokenizer, TokensMap, createTokenMapBasedOnCode, createTokensMaps, generateMapsForFormats, getFormatByFile, getSupportedFormats, tokenize };
